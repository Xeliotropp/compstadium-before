    ...
    <div class="col md-12">
        <div class="card">
            <div class="card-header">
                <h4>Добавете продукт
                    <a href="{{ url('admin/products') }}" class="btn btn-primary btn-sm text-white float-end">Назад</a>
                </h4>
            </div>
            <div class="card-body">
                @if ($errors->any())
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade border p-3" id="details-tab-pane" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="sale_price">Намалена цена</label>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        (Маркиран = Скрит, Не маркиран = Видим)
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                        ...
                        <div class="tab-pane fade border p-3" id="image-tab-pane" role="tabpanel"
                            ...
                            <div class="mb-3">
                                <label>Качете снимка/снимки на продукта</label><br><br>
                                <input type="file" class="form-control" name="image[]" multiple />
                            </div>
                        </div>
                    </div>
                    <div>
                        <button type="submit" class="btn btn-primary text-white float-end">Запази</button>
                    </div>
                </form>
            </div>
        </div>
